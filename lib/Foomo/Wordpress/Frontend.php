...
class Frontend
{
	...
	/**
	 * Unified way to add header scripts
	 *
	 * @param string $script
	 */
	...
	/**
	 * Unified way to add footer scripts
	 *
	 * @param string $script
	...
	public static function init()
	{
		...
		# add actions
		add_action('print_head_scripts', array(__CLASS__, '_print_head_scripts'));
		add_action('print_footer_scripts', array(__CLASS__, '_print_footer_scripts'));
		add_action('wp_print_footer_scripts', array(__CLASS__, '_wp_print_footer_scripts'));
	 ...
	 * @return output
	 */
	public static function _print_head_scripts()
	{
	 ...
	 * @return output
	 */
	public static function _wp_print_footer_scripts()
	{
	 ...
	 * @return output
	 */
	public static function _print_footer_scripts()
	{
	...
	public static function wpautop($pee, $br = 1)
	{
		...
		if (strpos($pee, '<pre') !== false) $pee = preg_replace_callback('!(<pre[^>]*>)(.*?)</pre>!is', 'clean_pre', $pee );
		$pee = preg_replace( "|\n</p>$|", '</p>', $pee );
